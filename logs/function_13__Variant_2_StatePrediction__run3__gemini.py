...
def test_heapify_nominal_left_largest():
    arr = [1, 5, 3]
    heapify(arr, 0, 3)
    assert arr == [5, 1, 3]


def test_heapify_nominal_right_largest():
    arr = [1, 3, 5]
    heapify(arr, 0, 3)
    assert arr == [5, 3, 1]


def test_heapify_nominal_root_largest():
    arr = [5, 3, 1]
    heapify(arr, 0, 3)
    assert arr == [5, 3, 1]


def test_heapify_boundary_heap_size_limits():
    arr = [1, 10, 100]
    heapify(arr, 0, 1)
    assert arr == [1, 10, 100]
