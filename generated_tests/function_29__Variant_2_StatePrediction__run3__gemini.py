...
def test_perfect_square_binary_search_negative():
    ...
    assert perfect_square_binary_search(-4) is False


def test_perfect_square_binary_search_large():
    assert perfect_square_binary_search(1000000) is True
    assert perfect_square_binary_search(1000002) is False
    assert perfect_square_binary_search(999999) is False
