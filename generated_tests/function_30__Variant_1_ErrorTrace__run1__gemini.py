...
def test_perfect_cube_nominal_true():
    ...
    assert perfect_cube(125) is True


def test_perfect_cube_nominal_false():
    assert perfect_cube(2) is False
    assert perfect_cube(7) is False
...
def test_perfect_cube_binary_search_nominal_true():
    ...
    assert perfect_cube_binary_search(1000) is True


def test_perfect_cube_binary_search_nominal_false():
    ...
    assert perfect_cube_binary_search(999) is False
    assert perfect_cube_binary_search(1001) is False
